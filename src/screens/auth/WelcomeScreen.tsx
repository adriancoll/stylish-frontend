  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.rowButtons}>
        <CustomButton type={ButtonTypes.SECONDARY} onPress={goToRegister} title='Regístrate' />
        <CustomButton type={ButtonTypes.SECONDARY} bgColor={theme.colors.primary} onPress={goToLogin} title='Iniciar sesión' />
      </View>
    </View>
  )
}
